...
# Print the variables
print("The city is", city, " and the price is", price, ". You need at least", high_score, "points to get to the high score score.")

# Exercise 4: Lesson 51
