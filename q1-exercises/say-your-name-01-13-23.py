...
cash:float = 19867324678987.99
split = round(cash/5,2)                         # Round to two decimal places
formattedSplit = "{:.2f}".format(split)         # Format so that the 2nd decimal place is persisted
